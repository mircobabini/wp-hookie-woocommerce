<?php
/*
Plugin Name: Hookie for Woocommerce
Plugin URI: http://mircobabini.com/
Description: Enables specific WooCommerce hooks to get shown into the page dom [Extension of Hookie (Visual Hook Reference)]
Version: 1.0.0
Author: mirkolofio
...
*/
    ...
    $hookie_woocommerce = new Hookie_WooCommerce();

    add_action( 'hookie_init_hooks', array( $hookie_woocommerce, 'init_hooks' ), 10, 1 );

    class Hookie_WooCommerce {
        private $hooks = array(
                    'woocommerce_init',
                    'woocommerce_loaded',
         ...
         * @since  1.0.0
         * @param  object $hookie Visual Hook Reference object.
         * @return  void
         */
        public function init_hooks ( $hookie ) {
            ...
            if ( isset( $_GET['wc-api'] ) ) {
                ...
                $hookie->add_hook( 'woocommerce_api_' . $api );
            }
        } // End init_hooks()
